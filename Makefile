...
$(ROOT)/build/test_ddr_720p_abi_origin: $(ROOT)/tests/unit/test_ddr_720p_abi_origin.cpp \
		$(ROOT)/host/libmisterplex/ddr_frame_layout.hpp \
		$(ROOT)/fpga/Plex_MiSTer/rtl/ddr_frame_layout_params.svh
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_ddr_720p_abi_origin.cpp
	$@
