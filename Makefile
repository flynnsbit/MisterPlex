...
unit-unlocked: unit-rollcall preflight $(ROOT)/build/test_cadence $(ROOT)/build/test_cadence_swap_path $(ROOT)/build/test_publish_interval_ledger $(ROOT)/build/test_publish_swap_delta_ledger $(ROOT)/build/test_plxd_liveness $(ROOT)/build/test_present_store_scale_math $(ROOT)/build/test_fabric_content_window_math $(ROOT)/build/test_present_scale_4_3_math $(ROOT)/build/test_present_scale_4_3_phase_oracle $(ROOT)/build/test_scale_4_3_vs_general $(ROOT)/build/test_present_scale_2x_math $(ROOT)/build/test_true_content_de_contract $(ROOT)/build/test_avclock $(ROOT)/build/test_audio_delay $(ROOT)/build/test_mraudio_status $(ROOT)/build/test_av_phase_rtl_quanta $(ROOT)/build/test_osd_menu $(ROOT)/build/test_osd_control $(ROOT)/build/test_last_frame_latch $(ROOT)/build/test_playback_overlay $(ROOT)/build/test_input_mailbox $(ROOT)/build/test_pixel_format $(ROOT)/build/test_main_guard $(ROOT)/build/test_death_breadcrumb $(ROOT)/build/test_frame_ledger $(ROOT)/build/test_supply_bucket $(ROOT)/build/test_raw_video_pipe $(ROOT)/build/test_status_telemetry $(ROOT)/build/test_resolve $(ROOT)/build/test_log_redact $(ROOT)/build/test_pms_timeline $(ROOT)/build/test_plextv_device $(ROOT)/build/test_companion_eof $(ROOT)/build/test_companion_plant_seek $(ROOT)/build/test_gdm_resources_parity $(ROOT)/build/pms_baseline_probe $(ROOT)/build/test_h264_bitstream_source $(ROOT)/build/test_bitstream_ring_lifecycle $(ROOT)/build/test_frame_store_math $(ROOT)/build/test_720p_geometry_lane_agree $(ROOT)/build/test_coded_size_adopt $(ROOT)/build/test_ffmpeg_vf $(ROOT)/build/test_force_scale_construction $(ROOT)/build/test_yuv420p_chroma_480p $(ROOT)/build/test_geom_frame_cost $(ROOT)/build/test_glass_loss_death_points $(ROOT)/build/test_frame_store_sdram_sim $(ROOT)/build/test_frame_store_ddr_prefetch_sim $(ROOT)/build/test_ddr_want_y_hblank_thrash $(ROOT)/build/test_ddr_bank_mailbox_phys $(ROOT)/build/test_ddr_scanout_multiframe $(ROOT)/build/test_sdram_memtest_sim $(ROOT)/build/test_sdram_mailbox $(ROOT)/build/test_annexb_count $(ROOT)/build/test_sps_parse $(ROOT)/build/test_slice_hdr $(ROOT)/build/test_cavlc_dc $(ROOT)/build/test_idct_quant $(ROOT)/build/test_p3_host_recon_vectors $(ROOT)/build/test_p3_idct_reference_model $(ROOT)/build/test_p3_inter_pred_vectors $(ROOT)/build/extract_h264_golden $(ROOT)/build/misterplexd
	...
	$(ROOT)/build/test_present_scale_4_3_math
	$(ROOT)/build/test_present_scale_4_3_phase_oracle
	$(ROOT)/build/test_scale_4_3_vs_general
	$(ROOT)/build/test_present_scale_2x_math
	...
	$(ROOT)/tests/unit/test_hdmi_motion_realcontent.sh
...
rtl-sim-unlocked:
	...
	$(ROOT)/tests/unit/test_ddr_qword_export_rtl_sim.sh
	$(ROOT)/tests/unit/test_stream_path_recon_integration.sh
	$(ROOT)/tests/unit/test_stream_path_full_frame_compare.sh
	$(ROOT)/tests/unit/test_ddram_frame_rd_bank_select.sh
	$(ROOT)/tests/unit/test_h264_syntax_primitives_rtl_sim.sh
...
# Pre-fit reachability: QIP membership + static root reachability (no fitter).
# Soft-skip rc=77 is NOT a pass. Missing inputs → rc=2 (fail, not pass).
prefit-reachability:
	$(ROOT)/scripts/check_prefit_reachability.py --root "$(ROOT)"
...
# Includes prefit-reachability (critical modules must not be pruned).
fit-gate:
...
$(ROOT)/build/test_720p_geometry_lane_agree: $(ROOT)/tests/unit/test_720p_geometry_lane_agree.cpp \
		$(ROOT)/host/libmisterplex/ddr_frame_layout.hpp \
		$(ROOT)/host/libmisterplex/geometry_units.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_720p_geometry_lane_agree.cpp
...
$(ROOT)/build/test_geom_frame_cost: $(ROOT)/tests/unit/test_geom_frame_cost.cpp \
		...
		$(ROOT)/host/libmisterplex/yuv420p_chroma_health.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_geom_frame_cost.cpp

$(ROOT)/build/test_glass_loss_death_points: $(ROOT)/tests/unit/test_glass_loss_death_points.cpp \
		$(ROOT)/host/libmisterplex/av_clock.hpp \
		$(ROOT)/host/libmisterplex/ddr_bank_release_select.hpp \
		$(ROOT)/host/libmisterplex/ddr_frame_layout.hpp \
		$(ROOT)/host/libmisterplex/ffmpeg_vf.hpp \
		$(ROOT)/host/libmisterplex/frame_ledger.hpp \
		$(ROOT)/host/libmisterplex/yuv420p_chroma_health.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_glass_loss_death_points.cpp
...
$(ROOT)/build/test_cadence_swap_path: $(ROOT)/tests/unit/test_cadence_swap_path.cpp $(ROOT)/host/libmisterplex/cadence.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_cadence_swap_path.cpp

$(ROOT)/build/test_publish_interval_ledger: $(ROOT)/tests/unit/test_publish_interval_ledger.cpp \
		$(ROOT)/host/libmisterplex/publish_interval_ledger.hpp \
		$(ROOT)/host/libmisterplex/ddr_bank_release_select.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_publish_interval_ledger.cpp

$(ROOT)/build/test_present_store_scale_math: $(ROOT)/tests/unit/test_present_store_scale_math.cpp \
		$(ROOT)/fpga/Plex_MiSTer/Plex.qsf \
		$(ROOT)/fpga/Plex_MiSTer/rtl/present_core.sv \
		$(ROOT)/fpga/Plex_MiSTer/rtl/ddr_frame_layout_params.svh
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_present_store_scale_math.cpp


$(ROOT)/build/test_fabric_content_window_math: $(ROOT)/tests/unit/test_fabric_content_window_math.cpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_fabric_content_window_math.cpp


$(ROOT)/build/test_present_scale_4_3_math: $(ROOT)/tests/unit/test_present_scale_4_3_math.cpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_present_scale_4_3_math.cpp

$(ROOT)/build/test_present_scale_4_3_phase_oracle: $(ROOT)/tests/unit/test_present_scale_4_3_phase_oracle.cpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_present_scale_4_3_phase_oracle.cpp

$(ROOT)/build/test_scale_4_3_vs_general: $(ROOT)/tests/unit/test_scale_4_3_vs_general.cpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_scale_4_3_vs_general.cpp


$(ROOT)/build/test_present_scale_2x_math: $(ROOT)/tests/unit/test_present_scale_2x_math.cpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_present_scale_2x_math.cpp


$(ROOT)/build/test_true_content_de_contract: $(ROOT)/tests/unit/test_true_content_de_contract.cpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_true_content_de_contract.cpp





$(ROOT)/build/test_plxd_liveness: $(ROOT)/tests/unit/test_plxd_liveness.cpp \
		$(ROOT)/host/libmisterplex/plxd_liveness.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_plxd_liveness.cpp

$(ROOT)/build/test_publish_swap_delta_ledger: $(ROOT)/tests/unit/test_publish_swap_delta_ledger.cpp \
		$(ROOT)/host/libmisterplex/publish_swap_delta_ledger.hpp \
		$(ROOT)/host/libmisterplex/publish_interval_ledger.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_publish_swap_delta_ledger.cpp
...
$(ROOT)/build/test_audio_delay: $(ROOT)/tests/unit/test_audio_delay.cpp \
		$(ROOT)/host/libmisterplex/audio_delay.hpp \
...
$(ROOT)/build/test_supply_bucket: $(ROOT)/tests/unit/test_supply_bucket.cpp \
		$(ROOT)/host/libmisterplex/supply_bucket.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_supply_bucket.cpp

$(ROOT)/build/test_raw_video_pipe: $(ROOT)/tests/unit/test_raw_video_pipe.cpp \
		$(ROOT)/host/libmisterplex/raw_video_pipe.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_raw_video_pipe.cpp
...
$(ROOT)/build/test_av_phase_rtl_quanta: $(ROOT)/tests/unit/test_av_phase_rtl_quanta.cpp \
		$(ROOT)/host/libmisterplex/av_phase_rtl_quanta.hpp \
		$(ROOT)/host/libmisterplex/input_mailbox.hpp \
		$(ROOT)/host/libmisterplex/mailbox_abi_spec.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_av_phase_rtl_quanta.cpp
