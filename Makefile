...
$(ROOT)/build/test_ddr_perf_decode: $(ROOT)/tests/unit/test_ddr_perf_decode.cpp $(ROOT)/host/libmisterplex/ddr_perf_counters.hpp $(ROOT)/host/libmisterplex/mailbox_abi_spec.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_ddr_perf_decode.cpp

$(ROOT)/build/test_fabric_dma_source: $(ROOT)/tests/unit/test_fabric_dma_source.cpp \
		$(ROOT)/host/libmisterplex/fabric_dma_source.hpp \
		$(ROOT)/host/libmisterplex/ddr_frame_layout.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -o $@ $(ROOT)/tests/unit/test_fabric_dma_source.cpp
