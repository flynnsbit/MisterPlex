...
$(ROOT)/build/test_ddr_bank_select_contended: $(ROOT)/tests/unit/test_ddr_bank_select_contended.cpp \
		$(ROOT)/host/libmisterplex/ddr_bank_release_select.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_ddr_bank_select_contended.cpp

$(ROOT)/build/test_ddr_playback_bank_select: $(ROOT)/tests/unit/test_ddr_playback_bank_select.cpp \
		$(ROOT)/host/libmisterplex/ddr_bank_release_select.hpp
	@mkdir -p $(ROOT)/build
	$(CXX) $(CXXFLAGS) -I$(ROOT)/host -o $@ $(ROOT)/tests/unit/test_ddr_playback_bank_select.cpp
