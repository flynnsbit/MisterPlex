...
| **3** FPGA decode / frame store | **3.3k hybrid** host recon F1 (mae=0); FPGA `res_dc` + DDR 3.1b **in RTL**, last green lab RBF = 3.3j (rebuild for H_TOTAL=638 + residual pending) |
