...
# WARM-UP REQUIRED: bare -frames:v 1 is DEFECTIVE on the USB grabber
# (uniform grey frame0 → false uniform_frame; parent 2026-07-31).
mkdir -p build/pair-visual
scripts/capture_hdmi_frame.sh build/pair-visual/idle.png
# equivalent: ffmpeg … -vf 'select=gte(n\,20)' -frames:v 1 -y …
