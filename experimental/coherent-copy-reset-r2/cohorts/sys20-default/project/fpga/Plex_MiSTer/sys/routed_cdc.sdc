# Routed SYS20 first-hop corrections. All local release chains, second stages,
...
namespace eval plex_routed_cdc {
	...
	proc install {} {
		set sys [::plex_framework_cdc::clock ROUTED-SYS {emu|pll|pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]
