module ddr_bitstream_reader_transport_tb_top #(
	...
	parameter [31:0] VIDEO_FEATURES = 32'd1,
	parameter [31:0] VIDEO_BUILD_ID = 32'hA1B2C3D4,
	...
	// Defaults remain transport-only. The functional variant checks physical
	// MPC publication of fields observed from the actual compiled emu; decoder
	// correctness is exercised separately by the original composed pictures.
	ddr_bitstream_reader #(.ENABLE_AU_PROTOCOL(ENABLE_AU_PROTOCOL),
	                       .MAX_AU_BYTES(MAX_AU_BYTES),
	                       .VIDEO_FEATURES(ENABLE_AU_PROTOCOL ? VIDEO_FEATURES : 32'd0),
	                       .VIDEO_BUILD_ID(ENABLE_AU_PROTOCOL ? VIDEO_BUILD_ID : 32'd0),
