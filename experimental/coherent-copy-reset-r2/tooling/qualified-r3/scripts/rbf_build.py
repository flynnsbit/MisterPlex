...
def prepare_reporting(work, meta):
    ...
    write_json(directory / "provenance.json", {
        "schema": "misterplex.timing-reporter.v5",
...
def verify_reporter(work, meta):
    ...
    if provenance["schema"] != "misterplex.timing-reporter.v5":
        raise RuntimeError("REFUSED: current build requires a v5 timing reporter")
