...
localparam int DDR_FRAME_PHYS_BASE = 32'h3000_0000;  // product dual-bank base
...
// ---- Dual-header Option-C 720p map (PL330 / geom handshake; not product banks) ----
// Product silicon constants are the DDR_FRAME_* block above (phys 0x30000000 /
// doorbell 0x302FF000). These 720P_* symbols remain for opt-in dual-header consumers.
