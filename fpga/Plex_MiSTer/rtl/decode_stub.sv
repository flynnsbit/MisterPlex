...
module decode_stub #(
	...
	wire signed [31:0] idct_dequant [0:15];
	wire signed [31:0] idct_residual [0:15];
	...
	// Preserve the legacy signed-nine diagnostic input, sign-extended into
	// the full-width shared dequant/transform leaves.
	wire signed [15:0] cavlc_s16 [0:15];
	wire signed [15:0] sat9_coeff [0:15];
	genvar sat_i;
	generate
	...
	// Keep the existing MB0 diagnostic reconstruction, independent of mb_ctrl.
