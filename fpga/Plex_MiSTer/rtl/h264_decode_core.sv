...
module h264_decode_core #(
    ...
    localparam [7:0] ST_DEBLOCK       = 8'd13;
...
`endif
    ...
    // Real in-loop deblock (bb1c62b sequential M10K gather/scatter).
    wire       dbf_out_valid;
...
`endif
            ...
            // Drain filter; force wait on last ref MB so POST hits DPB before boundary.
            ST_DEBLOCK: begin
