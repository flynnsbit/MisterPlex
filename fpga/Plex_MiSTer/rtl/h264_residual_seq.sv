...
// coeff_token_table: 0 = I16 luma DC (nC=0); 4 = chroma DC only; 7 = use nC.
...
module h264_residual_seq (
	...
	function automatic [3:0] luma_ord;
		...
		begin
			case (i)
			4'd0: luma_ord=4'd0;  4'd1: luma_ord=4'd1;  4'd2: luma_ord=4'd4;  4'd3: luma_ord=4'd5;
			4'd4: luma_ord=4'd2;  4'd5: luma_ord=4'd3;  4'd6: luma_ord=4'd6;  4'd7: luma_ord=4'd7;
			4'd8: luma_ord=4'd8;  4'd9: luma_ord=4'd9;  4'd10:luma_ord=4'd12; 4'd11:luma_ord=4'd13;
			4'd12:luma_ord=4'd10; 4'd13:luma_ord=4'd11; 4'd14:luma_ord=4'd14; default: luma_ord=4'd15;
			endcase
		end
	endfunction
	...
	task automatic present_ldc;
		begin
			// I16 luma DC table 0 / nC=0.
			// Table 4 is chroma DC only (max_coeff=4 / nC=-1).
			blk_valid <= 1'b1; mb_res_done <= 1'b0;
			blk_id <= 5'd16; max_coeff <= 5'd16;
			chroma_dc <= 1'b0; coeff_token_table <= 3'd0;
