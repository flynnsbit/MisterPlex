...
module stream_path #(
	...
	// Decode core geometry follows FRAME_* so 320x240 benches and 624x480
	// product both elaborate. Plex.sv must pass the coded size, not 640-wide.
	...
	// Two-master mux: bitstream reader + DPB share the single DDR port.
	wire        bsr_bus_want;
	...
	wire core_error;
	// h264_decode_core.slice_start is a PULSE: edge-detect slice_valid level.
