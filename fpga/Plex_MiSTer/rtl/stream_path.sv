...
module stream_path #(
	...
	// multi-MB syntax walker until the baseline datapath fits.
	...
	h264_i_mb_feed #(
		...
		// Lite feed only presents first_mb; MVP assumes first_mb_in_slice==0.
		assign feed_mb_x = 8'd0;
		assign feed_mb_y = 8'd0;
