...
# Primary product geometry is 480p (dual-header SSOT). Do NOT pair kPlex720p*
# with bare DDR_FRAME_* — that is land's single-header collapse and false-reds
# a correct dual-header tree. 720p lives in DDR_LAYOUT_PAIRS_720P only.
