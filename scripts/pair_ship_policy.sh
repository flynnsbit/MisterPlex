...
_PAIR_C74C="${RBF_PIN_DDR_C74C6863_PREFIX8:-c74c6863}"
PAIR_MATRIX_ROWS=(
  ...
  # Glass-OK product core (daily) + CURRENT live daemon 9ce2c2d1
  "${_PAIR_GLASS}|${_PAIR_DDR_DAEMON}|${DEVICE_CORE_PRODUCT}|ddr|ddr-8fdf440f|ddr|${PAIR_BANK1_DDR}"
  "${_PAIR_GLASS}|${DAEMON_PIN_DDR_9CE2C2D1_FULL}|${DEVICE_CORE_PRODUCT}|ddr|ddr-8fdf440f-9ce2c2d1|ddr|${PAIR_BANK1_DDR}"
  ...
  # c74c6863 glass-OK alternate (parent viewed-pixels 2026-08-01; more ALM/M10K)
  "${_PAIR_C74C}|${_PAIR_DDR_DAEMON}|${DEVICE_CORE_PRODUCT}|ddr|ddr-c74c6863|ddr|${PAIR_BANK1_DDR}"
  "${_PAIR_C74C}|${DAEMON_PIN_DDR_9CE2C2D1_FULL}|${DEVICE_CORE_PRODUCT}|ddr|ddr-c74c6863-9ce2c2d1|ddr|${PAIR_BANK1_DDR}"
  "${_PAIR_C74C}|${DAEMON_PIN_DDR_E9F79DE2_FULL}|${DEVICE_CORE_PRODUCT}|ddr|ddr-c74c6863-e9f79de2|ddr|${PAIR_BANK1_DDR}"
  # c5382bee historical (lab bak only)
  "${_PAIR_C5382}|${_PAIR_DDR_DAEMON}|${DEVICE_CORE_PRODUCT}|ddr|ddr-c5382bee|ddr|${PAIR_BANK1_DDR}"
  "${_PAIR_C5382}|${DAEMON_PIN_DDR_9CE2C2D1_FULL}|${DEVICE_CORE_PRODUCT}|ddr|ddr-c5382bee-9ce2c2d1|ddr|${PAIR_BANK1_DDR}"
...
PAIR_ID_DDR_GLASS_LIVE=ddr-8fdf440f-9ce2c2d1
PAIR_ID_DDR_C74C=ddr-c74c6863
PAIR_ID_DDR_C74C_LIVE=ddr-c74c6863-9ce2c2d1
...
# Default DDR restore target = currently-live verified pair (not an older pin).
PAIR_DEFAULT_ROLLBACK="${PAIR_DEFAULT_ROLLBACK:-$PAIR_ID_SPI_HYBRID}"
PAIR_DEFAULT_PROMOTE="${PAIR_DEFAULT_PROMOTE:-$PAIR_ID_DDR_GLASS_LIVE}"
PAIR_DEFAULT_DDR_RESTORE="${PAIR_DEFAULT_DDR_RESTORE:-$PAIR_ID_DDR_GLASS_LIVE}"
