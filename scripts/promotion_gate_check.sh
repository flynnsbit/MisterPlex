...
# Defaults align with promote_ddr_daily.sh / rbf_ship_policy.sh on main.
# Lab c5382bee candidate + resolved DDR primary daemon. Override with
# PROMOTE_EXPECT_* for fixtures only. (Older glass 9ce2 pins may be unset.)
EXPECT_CORE_MD5="${PROMOTE_EXPECT_CORE_MD5:-${RBF_PIN_DDR_PROMOTE_FULL:-${RBF_PIN_DDR_GLASS_OK_FULL:-$RBF_PIN_DDR_CANDIDATE_FULL}}}"
EXPECT_DAEMON_MD5="${PROMOTE_EXPECT_DAEMON_MD5:-${DAEMON_PIN_DDR_PRIMARY_FULL:-${DAEMON_PIN_DDR_9CE2C2D1_FULL:-$DAEMON_PIN_DDR_CANDIDATE_FULL}}}"
