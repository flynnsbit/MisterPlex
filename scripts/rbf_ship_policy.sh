...
#   3883f5ab  CURRENT live (parent hand-deploy 2026-08-01; /proc/20943/exe)
...
rbf_policy_ddr_daemon_accepted() {
  ...
  p8="${d:0:8}"
  case "$p8" in
    "$DAEMON_PIN_DDR_3883F5AB_PREFIX8"|"$DAEMON_PIN_DDR_5996385A_PREFIX8"|"$DAEMON_PIN_DDR_B981_PREFIX8"|"$DAEMON_PIN_DDR_EDC3_PREFIX8"|"${DAEMON_PIN_DDR_E9F79DE2_FULL:0:8}")
      return 0 ;;
  esac
  return 1
}
