...
# Unit fixtures set MISTERPLEX_PREFLIGHT_SKIP_LOCAL_QUARTUS=1 so synthetic
# meminfo/vmstat cases stay deterministic while w-fit holds the exclusive slot.
if [[ "${MISTERPLEX_PREFLIGHT_SKIP_LOCAL_QUARTUS:-0}" != "1" ]]; then
