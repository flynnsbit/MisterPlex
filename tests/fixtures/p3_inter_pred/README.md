...
- `plex_inter_p16_baseline_624x480_12f.264` — the same deterministic P16-only pattern at the settled coded geometry (624×480). Its per-frame I420 goldens live under `tests/fixtures/p3_frame_planes/`.
