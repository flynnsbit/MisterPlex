 ...
 *
 * Daemon telemetry can close identity with drops=8 while display loses ~1.5% of
 * source frames (parent pixel measure). Timeline advance alone is blind to that.
 *
 ...
 * (same denominator class as parent "22 skips / 1429 source frames").
 *
