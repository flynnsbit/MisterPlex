...
MISTERPLEX_BASELINE_KEY="${MISTERPLEX_BASELINE_KEY:-$(conf_val MISTERPLEX_BASELINE_KEY "$CONF_FILE")}"
MISTERPLEX_BASELINE_KEY="${MISTERPLEX_BASELINE_KEY:-$(conf_val PLEX_KEY "$CONF_FILE")}"
