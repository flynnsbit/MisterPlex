#include "Vddr_beat_patched_tb.h"
#include "verilated.h"
#include <cstdint>
#include <iostream>
#include <memory>
...
int main(int argc, char** argv) {
    ...
    auto top = std::make_unique<Vddr_beat_patched_tb>();
    ...
    if (dl) { std::cerr << "DEADLOCK after " << seen << "/" << issued << "\n"; return 2; }
    if (!pass) { std::cerr << "FAIL: " << seen << "/" << issued << "\n"; return 1; }
    std::cout << "OK\n";
    return 0;
}
