...
module ddr_publish_copy_budget_tb_top (
	...
	output wire [31:0] t_fab_vs_present,
	...
	output wire        fab_cont_beats_arm,
	output wire        fab_fits_24,
	output wire        fab_cont_fits_24,
	output wire        pl330_fits_24,
	output wire        pl330_beats_fab_cont,
	...
	ddr_publish_copy_budget #(
		...
		.prereg_t_fabric_vs_present_us(t_fab_vs_present),
		.r_req_Bps(r_req),
		.t_pl330_us(t_pl330),
		...
		.fabric_contended_beats_arm(fab_cont_beats_arm),
		.fabric_ideal_fits_24(fab_fits_24),
		.fabric_contended_fits_24(fab_cont_fits_24),
		.pl330_est_fits_24(pl330_fits_24),
		.pl330_beats_fabric_contended(pl330_beats_fab_cont),
