...
// CAVLC bitstrings encoded with H.264 nC neighbour prediction (same rules as
// h264_decode_core p16_tc_* caches). Tables change once left/above TotalCoeff
// are non-zero; always-table-0 fixtures are intentionally invalid under real nC.
const char* residualBlockBits(int mbIdx, int block) {
    static const char* kMb0[24] = {
        "0000011100001100111", // 0  nC=0 tab0 [1,4]
        "01100111",           // 1  nC=2 tab1 [1,1]
        "00011100001100111",  // 2  nC=2 tab1 [1,4]
        "01100111",
        "00011100001100111",
        "01100111",
        "00011100001100111",
        ...
        "00011100001100111",
        "01100111",
        "00100111",           // 16 U nC=0 tab0 [1,1]
        "01100111",
        "01100111",
        "01100111",
        "0000011100001100111", // 20 V nC=0 tab0 [1,4]
        "00011100001100111",
        "00011100001100111",
        "00011100001100111",
    };
    static const char* kMb1[24] = {
        "0011100000000000000001000001111110111", // 0 high [80,1] nC=2 tab1 (left MB)
        "01100111",
        "00011100001100111",
        "01100111",
        "00011100001100111",
        ...
        "00011100001100111",
        "01100111",
        "0011100000000000000001000001111110111", // 16 U high nC=2 tab1
        "01100111",
        "01100111",
        "01100111",
        "00011100001100111", // 20 V nC=2 tab1 [1,4]
        "00011100001100111",
        "00011100001100111",
        "00011100001100111",
    };
    static const char* kMb2[24] = {
        "00011100001100111",
        "01100111",
        "00011100001100111",
        "01100111",
    ...
    if (mbIdx == 0) return kMb0[block];
    if (mbIdx == 1) return kMb1[block];
    return kMb2[block];
}
