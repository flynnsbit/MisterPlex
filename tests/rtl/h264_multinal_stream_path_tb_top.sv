...
module h264_multinal_stream_path_tb #(
    ...
    stream_path #(.FRAME_W(16), .FRAME_H(16)) dut (
        ...
        .hybrid_fpga_owned(),
        .hybrid_host_required(),
        .product_recon_ok(),
        .hybrid_own_code(),
        .hybrid_own_reason(),
        .entropy_cabac(),
        .fs_wr_en(fs_wr_en), .fs_wr_pixel(fs_wr_pixel),
        .p_mb_valid(p_mb_valid),
        .p_mb_addr(p_mb_addr),
        .p_mb_x(p_mb_x),
        .p_mb_y(p_mb_y),
        .p_mb_skip(p_mb_skip),
        .p_mb_part_mode(p_mb_part_mode),
        .p_mb_part_count(p_mb_part_count),
        .p_mb_uses_sub_mb(p_mb_uses_sub_mb),
        .p_mb_intra(p_mb_intra),
