...
//
// Combo: flex dequant, plain dequant, chroma DC, chroma epel.
// Sequential: luma DC Hadamard (clk/start/done) and h264_iq_idct_seq.
// Parallel idct4x4 on flex is exposed for seq bit-exact compare.
