...
// PLXD at doorbell+0x128 = 0x300FF128. Residue at the legacy address desyncs
// free_bank_mask / bank targeting.
//
// Cases:
//   A) product doorbell → PLXD 0x300FF128 (not 0x3007F128)
...
int main() {
    ...
    expect(product.u_offset == static_cast<uint32_t>(kPlex480pUPlaneOffset),
           "U plane offset 299520 (0x49200)");
    expect(product.u_offset == 299520u, "U offset literal");
