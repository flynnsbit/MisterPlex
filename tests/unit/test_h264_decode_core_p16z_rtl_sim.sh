...
echo "Scope: h264_decode_core staging P16 path; no hierarchical RTL pokes; covers 3/1170 MBs with syntax handoff, MV-neighbour prediction, CAVLC residual scheduling, h264_inter_mc_part full-window MC, and DPB writeback; not full-frame product reachability."
set +e
