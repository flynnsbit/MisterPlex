...
mkdir -p "$BUILD" "$BUILD_DROP_PRED" "$BUILD_DROP_RES" "$BUILD_PERTURB_MV" "$BUILD_BAD_RBSP" "$BUILD_DROP_MV_NB" "$BUILD_DROP_SCHED_RES" "$BUILD_DROP_LAST_LUMA_RES" "$BUILD_SWAP_SCHED_COEFF" "$BUILD_SWAP_CHROMA_READ"
