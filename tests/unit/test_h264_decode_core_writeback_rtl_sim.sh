...
XFORM_RTL="$ROOT/fpga/Plex_MiSTer/rtl/h264_transform_dc.sv"
MC_BLOCK_RTL="$ROOT/fpga/Plex_MiSTer/rtl/h264_mc_block.sv"
MC_LUMA_RTL="$ROOT/fpga/Plex_MiSTer/rtl/h264_mc_luma_qpel.sv"
MC_CHROMA_RTL="$ROOT/fpga/Plex_MiSTer/rtl/h264_mc_chroma_epel.sv"
DEBLOCK_MB_RTL="$ROOT/fpga/Plex_MiSTer/rtl/h264_deblock_mb.sv"
PERF_RTL="$ROOT/fpga/Plex_MiSTer/rtl/h264_perf_counters.sv"
