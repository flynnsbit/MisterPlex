...
// Product locator: exact argv0 OR resolved exe == "/media/fat/MiSTer" (no substring).
// Multi-match refuses; vanishing /proc entries are skipped (no abort).
// Host fixtures use execv argv0 override (exe=/bin/sleep) — argv0 path still matches.
