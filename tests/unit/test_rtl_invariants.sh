...
# Geometry layer: dual-header primary 624->320 CODED_W/Y_STRIDE is the classic shear.
# (720p tier pairs kPlex720p*↔DDR_FRAME_720P_*; fault injects into primary DDR_FRAME_*.)
