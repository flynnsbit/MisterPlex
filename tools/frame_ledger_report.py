...
SCOPE: ARM_PUBLISH_NOT_DISPLAY — counters are daemon present/drop path,
NOT PLXD frames_done / display swaps. LEDGER_OK ≠ zero glass skips.
...
def print_row(
    ...
    *,
    ...
    if require_explained and not row.explained_ok:
        ...
        return RC_FAIL
    print(f"VERDICT=LEDGER_OK scope=ARM_PUBLISH_NOT_DISPLAY not_display_swap rc={RC_OK}")
    return RC_OK
